...
const MissionChatIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-square-text"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><path d="M14 8H8"/><path d="M16 12H8"/></svg>;
            ...
            <div className="flex flex-col justify-between flex-1 mt-6">
                <nav className="px-2">
                    ...
                    {canViewManagementDashboards(user) && (
                        <>
                            <SidebarNavLink to="/mission-chats" icon={<MissionChatIcon />}>Mission Chats</SidebarNavLink>
