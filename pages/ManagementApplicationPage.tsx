...
const ManagementApplicationPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    addNotification({ type: 'success', message: `Thank you, ${fullName}. Your management application has been submitted for owner review.` });
    navigate('/');
  };
      ...
      <div className="max-w-xl w-full space-y-8 bg-white p-10 rounded-xl shadow-lg">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-sss-grey">
            For Dispatch & Secretary Positions
          </p>
        </div>
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <textarea
            ...
            placeholder="Summarize your administrative experience, qualifications, and why you are a good fit for a management role at SSS."
            value={experience}
